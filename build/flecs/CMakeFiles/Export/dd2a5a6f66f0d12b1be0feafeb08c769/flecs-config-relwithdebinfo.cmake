...
# Import target "flecs::flecs" for configuration "RelWithDebInfo"
set_property(TARGET flecs::flecs APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)
set_target_properties(flecs::flecs PROPERTIES
  IMPORTED_IMPLIB_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/flecs.lib"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/flecs.dll"
  )
...
set_target_properties(flecs::flecs_static PROPERTIES
  ...
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/flecs_static.lib"
  )
